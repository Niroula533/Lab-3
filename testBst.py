...
class BSTTestCase(unittest.TestCase):        
    ...
    def test_add(self):
        ...
        self.assertEqual(bsTree.search(10), 1)
        self.assertEqual(bsTree.search(15), 0)
    ...
    def test_search(self):
        ...
        self.bst.add(90)
        self.assertEqual(self.bst.search(90), 6)
    ...
    def test_smallest(self):
        ...
        tests for smallest
        """
        self.assertEqual(self.bst.smallest(), 1)
        ...
        self.assertEqual(self.bst.smallest(), 0)

    def test_largest(self):
        """
        tests for largest
        """
        self.assertEqual(self.bst.largest(), 52)
        ...
        self.assertEqual(self.bst.largest(), 54)
